		...
		if(!empty($id) && !empty($password))
		   {
			...
			$query="select * from trainer where id = '$id' limit 1";
			...
			if($result && mysqli_num_rows($result)>0)
			{
				...
				{
          $query=mysqli_query($con,"SELECT * FROM trainer WHERE id = '$id' AND password = '$password'");
          $num_rows=mysqli_num_rows($query);
          $row=mysqli_fetch_array($query);
          $_SESSION["id"]=$row['id'];
					header("Location: indexTrainer.html");
					die;
				}
			}
		}
              ...
              <div class="navbar-nav py-0">
                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu rounded-0 m-0">
                    <a href="latestnews.html" class="dropdown-item">Blog List</a>

  ...
  <body>
          ...
          >
            ...
            >
              <div class="navbar-nav py-0">
                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu rounded-0 m-0">
                    ...
                    <a href="single.html" class="dropdown-item">Archive</a>
                  </div>
                </div>
              ...
              <div class="nav-item dropdown">
                ...
                >
                <div class="dropdown-menu rounded-0 m-0">
                  <a href="usercourse.php" class="dropdown-item">My Course</a>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <h2>Welcome to admin page.<span></span></h2>
      </div>
      <br>
      <div class="admin">
        <br>
...
<?php
    ...
    $sql = "UPDATE class SET trainer='$trainer' WHERE id='$id'";

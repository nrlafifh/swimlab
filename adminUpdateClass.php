...
$result = mysqli_query($con, "SELECT * FROM class WHERE id=$id");
...
<div class="container-fluid d-none d-lg-block">
	...
	<form method="post" action="adminClassUpdate.php" style="padding-left: 30%;">
		<table>
			<tr>
				<td>Trainer ID &emsp;</td>
				<td><input type="text" name="trainer" value="<?php echo $trainer;?>"></td>
			</tr>
			<tr>
				<td>Day</td>

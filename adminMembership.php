        ...
        <div class="col-lg-9">
          ...
          >
            ...
            <div class="navbar-nav py-0">
                ...
                <a href="adminMembership.php" class="nav-item nav-link active">Membership</a>
              ...
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 m-0">
                  <a href="adminprofile.html" class="dropdown-item">My Profile</a>
        ...
        <h5
          ...
          >
            Membership List
					...
					<table class="table">
						<tbody>
							<?php include 'readMembership.php'; ?>
						</tbody>
					</table>
                </div>
            </div>

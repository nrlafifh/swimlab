...
<html lang="en">
          ...
          >
            ...
            >
              <div class="navbar-nav py-0">
                ...
                <a href="aboutAdmin.html" class="nav-item nav-link">About</a>
                <a href="courseAdmin.html" class="nav-item nav-link">Courses</a>
                <a href="trainerAdmin.html" class="nav-item nav-link">Trainers</a>
              </div>
              <a
  ...
  <form method="post" action="#" enctype = "multipart/form-data">
      ...
      <div class="container">
        <div class="main-body">
          <div class="row">
            ...
            <input type="submit" name="submitadmin" class="btn btn-primary" style="width:20em; margin:0;" value="Save"><br><br>
          </div>
                </div>
              </div>
        </form>
    ...
    <!-- Profile End -->
      ...
      $query = "UPDATE admin SET name = '$name', email = '$email', password = '$password', image = '$image'
                      WHERE id = '$id'";
